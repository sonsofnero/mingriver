...
<section class="breadcrumb">
  <div class="centerizer">
    <ul class="breadcrumb-list">
      ...
      <li>Beginners Guide to Baijiu</li>
    </ul>
  </div>
</section>
<!--End: Breadcrumb-->
  ...
  <div class="centerizer">
    ...
    <div class="article-hdr">
			<ul class="inner-share">
				<li class="sm-title"><span>Share</span></li>
      ...
      <h1 class="h1">Beginners Guide to Baijiu</h1>

      <ul class="article-meta">
        <li>Category: <a href="">Articles</a></li>
        <li class="spacer"></li>
        <li>Written By: <a href="">Simon Dang</a></li>
      </ul>
    </div>
    <!--End: Article Header-->
    ...
    <div class="article-start text-block text-block__pad">
      ...
      <figure class="feature-img">
        <img src="assets/placeholders/large-article-img2.jpg">
        <figcaption>The Excerpt of the Post Goes Here The Excerpt of the Post Goes Here The Excerpt of the Post Goes Here</figcaption>
      </figure>
      ...
      <p>When a restaurant with the name Opium opens and starts selling Baijiu we’re sorely tempted to file it in the bin without a second look. When a restaurant with the name Opium opens and starts selling Baijiu we’re sorely tempted to file it in the bin without a. When a restaurant with the name Opium opens and starts selling Baijiu we’re sorely tempted to file it in the bin without a second look. When a restaurant with the name Opium opens and starts selling Baijiu we’re sorely tempted to file it in the bin without a second look. When a restaurant with the name Opium opens and starts selling Baijiu we’re sorely tempted to file it in the bin without a second look.</p>
        ...
        <img src="assets/placeholders/small-article-img1.png">
		  ...
		  <p><blockquote>“When a restaurant with the name Opium opens and starts selling Baijiu we’re sorely tempted to file it in the bin without a second look.“</blockquote></p>
        ...
        <img class="body-img" src="assets/placeholders/small-article-img1.png">
			...
			<div class="grid-row grid-row__2block push-down-1">
				...
				<a class="gallery-img grid-item" href="assets/placeholders/small-article-img1.png" data-fancybox="gallery" data-caption="Caption #1">
...
<section class="more-articles">
  <div class="centerizer">
    ...
    <span class="h4">More Articles</span>

    <div class="grid-row grid-row__3block">

      <div class="grid-item">
        <div class="content-block">
          <a href="" class="h4">Press Post</a>
        </div>
        <img src="assets/placeholders/small-article-img1.png">
      </div>
